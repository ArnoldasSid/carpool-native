...
import { OTHER_USER_ADDED, OTHER_USERS_LOCATION_UPDATED, OTHER_USERS_ROLE_UPDATED } from '../constants.js';
...
describe('other user flow', () => {
  describe('Received a ride request', () => {
    it('If it is a new user he is added to other users and his locations are updated', () => {
      ...
      return checkIfLocationReceived(requesterId, store).then(locationReceived =>
