...
function* idleFlow(): any {
  ...
  if (r && r.userRequestedRide) {
    ...
    yield fork(
      acceptRequest,
      r.userAcceeptedRideRequest.payload.payload,
...
function* requesterFlow(): any {
  ...
  if (r2 && r2.userWithdrawnRequest) {
    ...
    alert(
      `Your trip request has been automatically withdrawn because ${maxTripDuration /
...
function* riderFlow(driverId: string): any {
  ...
  if (r && r.timeout) {
    ...
    alert(
      `Your trip has been automatically completed because ${maxTripDuration /
        60000} minutes after its start have passed`,
    );
  }
